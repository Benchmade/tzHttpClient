...
public final class ConnManagerParams {//待修改
	...
	public static enum Options{
		...
		CONNECTION_TIMEOUT(2000),//连接服务器超时时间
		WRITE_TIMEOUT(3000),//向服务器发送写请求超时
		READER_TIMROUT(5000),//读取response超时时间
		CONNECT_TIMEOUT_EXPIRE(10000),//keepAlive超时时间
		GET_CONN_WAIT_TIMEOUT(3000),//获得conn对象等待超时时间.高并发时为了防止conn过多内存溢出
		CONN_MAX_NUM_PER_HOST(10);//每个host最大拥有的连接数.
		private int value;
