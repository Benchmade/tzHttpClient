...
public class SimpleHttpConnectionManager implements HttpConnectionManager {
	...
	private static final String MISUSE_MESSAGE = "SimpleHttpConnectionManager being used incorrectly.  Be sure that" + " HttpMethod.releaseConnection() is always called and that only one thread"
